...
public class SpreadSheet {
  ...
  public SpreadSheet() {
    ...
    this.fontFamily = this.fontFactory.getFont();
    generateCells();
  }
  ...
  public void setFontFamily(int row, int col, String fontFamilyName) {
    ensureCellExists(row, col);

    var cell = cells[row][col];
    FontFamily font = fontFactory.getFont(fontFamilyName);
    cells[row][col].setFontFamily(font);
  }
